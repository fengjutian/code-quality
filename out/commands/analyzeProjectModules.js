...
exports.registerAnalyzeProjectModulesCommand = registerAnalyzeProjectModulesCommand;
 ...
 */
function analyzeProjectModules(rootPath) {
    const modules = [];
    const dependencies = [];
                ...
                if (stat.isDirectory()) {
                    ...
                    if (['.ts', '.tsx', '.js', '.jsx'].includes(ext) && !ignoredExts.includes(ext)) {
                        if (!visitedFiles.has(filePath)) {
                            ...
                            const fileModules = (0, analyzeImports_1.analyzeFileImports)(filePath);
 ...
 * 注册整个项目模块分析命令
 */
function registerAnalyzeProjectModulesCommand() {
    return vscode.commands.registerCommand('extension.analyzeProjectModules', () => {
        ...
        vscode.window.withProgress({
            ...
            // 创建Webview面板
            const panel = vscode.window.createWebviewPanel('projectModulesVisualization', '项目模块可视化', vscode.ViewColumn.Beside, {
                enableScripts: true,
...
//# sourceMappingURL=analyzeProjectModules.js.map